...
- 4 formules de paiement sélectionnables + montant dû recalculé
- Calcul détaillé personnes × nuits × tarif par personne
- Justificatif (cachet + signature) affiché après la demande et dans l'espace client
- Annulation client + formulaire bancaire de remboursement
